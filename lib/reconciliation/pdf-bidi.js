...
// Vendored from Mozilla PDF.js v6.1.200, the exact reader version pinned in
// pdf-stream-integrity.ts. Used only to VERIFY extracted text against glyph
// painting order, never to invent/reverse financial source values.
// Change from upstream: unsupported character types throw rather than warn.
const warn = () => { throw new Error('تعذر التحقق من اتجاه ترميز PDF'); };
